...
require_relative 'doing/string/normalize'
require_relative 'doing/string/truncate'
require_relative 'doing/string/url'
require_relative 'doing/string/query'
require_relative 'doing/string/tags'
require_relative 'doing/string/highlight'
require_relative 'doing/string/chronify'
