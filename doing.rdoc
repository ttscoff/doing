...
===== -e|--editor
Edit duplicated entry with /Users/ttscoff/scripts/editor.sh before adding
...
Show a config key value. Separate key paths with colons or dots, e.g. "export_templates.html". Use . to output the entire config.
