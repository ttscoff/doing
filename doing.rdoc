...
Cancel the last X entries containing TAG. Separate multiple tags with comma (--tag=tag2,tag2)
...
Finish the last X entries containing TAG.
  Separate multiple tags with comma (--tag=tag2,tag2), combine with --bool
